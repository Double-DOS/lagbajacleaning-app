...
Widget overviewContainer(String sessionCount, Color color, String caption, double width) {
    ...
    return Container(
      child: FutureBuilder(
          ...
          builder: (BuildContext context,
              AsyncSnapshot<SessionOverview> snapshot) {
            return !snapshot.hasData? SpinKitChasingDots(
              color: Colors.blue,
            ):
            CarouselSlider(
              ...
              items: [
                overviewContainer(snapshot.data.pending,
                    Colors.blue[200], "Pending", screenWidth*0.5),
                overviewContainer(snapshot.data.completed,
                    Colors.blue[500], "Completed", screenWidth*0.5),
                overviewContainer(
                    snapshot.data.total, Colors.blue[800], "Total", screenWidth*0.5),
              ],
            );
          }),
    );
